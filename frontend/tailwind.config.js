...
export default {
  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        'classic': ['Inter', 'system-ui', '-apple-system', 'BlinkMacSystemFont', 'Segoe UI', 'sans-serif'],
      },
      animation: {
      ...
      backgroundImage: {
        ...
        'gradient-purple-radial': 'radial-gradient(circle at top right, #a855f7, #7c3aed, #6d28d9)',
      }
    },
  },
  plugins: [],
